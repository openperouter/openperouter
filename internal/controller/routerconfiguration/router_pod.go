...
func (r *RouterPod) Updater(ctx context.Context) (frr.ConfigUpdater, error) {
	updater := frrconfig.UpdaterForAddress(fmt.Sprintf("%s:%d", r.pod.Status.PodIP, r.manager.FRRReloadPort), r.manager.FRRConfigPath)
	return updater, nil
}
