			...
			underlays: []v1alpha1.Underlay{
				{
					Spec: v1alpha1.UnderlaySpec{
						...
						Neighbors:    []v1alpha1.Neighbor{{Address: ptr.To("192.168.1.1"), ASN: ptr.To(int64(65001))}},
					},
				},
			},
			vnis:          []v1alpha1.L3VNI{},
			...
			underlays: []v1alpha1.Underlay{
				{
					Spec: v1alpha1.UnderlaySpec{
						...
						RouterIDCIDR: ptr.To("10.0.0.0/24"),
						Neighbors:    []v1alpha1.Neighbor{{Address: ptr.To("192.168.1.1"), Type: ptr.To("external")}},
					},
				},
			},
			vnis:          []v1alpha1.L3VNI{},
