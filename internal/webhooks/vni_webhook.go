...
func (v *VNIValidator) Handle(ctx context.Context, req admission.Request) (resp admission.Response) {
	...
	case v1.Create:
		if err := validateVNICreate(&vni); err != nil {
			return admission.Denied(err.Error())
		}
	case v1.Update:
		if err := validateVNIUpdate(&vni); err != nil {
			return admission.Denied(err.Error())
		}
	case v1.Delete:
		if err := validateVNIDelete(&vni); err != nil {
			return admission.Denied(err.Error())
		}
	}
...
func validateVNICreate(vni *v1alpha1.VNI) error {
...
func validateVNIUpdate(vni *v1alpha1.VNI) error {
...
func validateVNIDelete(_ *v1alpha1.VNI) error {
	return nil
}

func validateVNI(vni *v1alpha1.VNI) error {
