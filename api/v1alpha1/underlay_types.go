...
// +kubebuilder:validation:XValidation:rule="(has(self.vtepcidr) && self.vtepcidr != ”) != (has(self.vtepInterface) && self.vtepInterface != ”)",message="exactly one of vtepcidr or vtepInterface must be specified"
