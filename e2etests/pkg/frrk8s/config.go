...
func ConfigFromVNIForIPFamily(vni v1alpha1.L3VNI, family IPFamily, tweak ...func(*frrk8sapi.FRRConfiguration)) (*frrk8sapi.FRRConfiguration, error) {
	if family == IPv4 {
		if vni.Spec.LocalCIDR.IPv4 == "" {
...
func createFRRConfig(vni v1alpha1.L3VNI, cidr string, family IPFamily, tweak ...func(*frrk8sapi.FRRConfiguration)) (frrk8sapi.FRRConfiguration, error) {
