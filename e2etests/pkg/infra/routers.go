...
func init() {
	...
	links.Add("clab-kind-leafkind1", "pe-kind-control-plane", "192.168.11.2", "192.168.11.3")
	links.Add("clab-kind-leafkind1", "pe-kind-worker", "192.168.11.2", "192.168.11.4")
	links.Add("clab-kind-leafkind1", "clab-kind-spine", "192.168.1.5", "192.168.1.4")
