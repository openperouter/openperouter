...
const (
	...
	l3VNIConfiguredTestSelector = "EXTERNAL.*l3vni.*configured"
	l3VNIDeletedTestSelector    = "EXTERNAL.*l3vni.*deleted"
	l2VNIConfiguredTestSelector = "EXTERNAL.*l2vni.*configured"
