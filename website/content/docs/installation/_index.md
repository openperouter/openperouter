...
```bash
kubectl apply -f https://raw.githubusercontent.com/openperouter/openperouter/v0.3.0/config/all-in-one/openpe.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openperouter/openperouter/v0.3.0/config/all-in-one/crio.yaml
```
...
resources:
  - github.com/openperouter/openperouter/config/default?ref=v0.3.0
```
...
namespace: openperouter-system
resources:
  - github.com/openperouter/openperouter/config/crio?ref=v0.3.0
```
