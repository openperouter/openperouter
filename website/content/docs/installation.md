...
- `openperouter-nodemarker-*` (node labeller daemonset)

## Next Steps

After successful installation:

1. Configure the [underlay connection](../configuration.md#underlay-configuration) to your external router
2. Set up [VNI configurations](../configuration.md#vni-configuration) for your EVPN overlays
3. Test the integration with [BGP-speaking components](../examples/)

For troubleshooting, check the [contributing guide](../contributing/) for development environment setup and debugging information.
