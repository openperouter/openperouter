...
- OpenPERouter installed and configured (see [Installation](../installation.md))
- A [development environment](../contributing/devenv.md) with two L3 VNIs available from the fabric
...
[View MetalLB Integration Example →](./metallb.md)
