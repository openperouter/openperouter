...
5. **Check CRD state** — compare the dumped resource lists against what the test expected to configure. Check `RouterNodeConfigurationStatusList.log` for failed resources and degraded router nodes.
