...
spine (matched pattern: spine)
  ...
  BGP: AS 65000, 3 peers (leafA, leafB, leafkind), EVPN enabled

leaf-kind (matched pattern: leaf-kind)
  Role: transit
  Router ID: 10.0.0.1
  Interfaces:
    eth1 -> spine (192.168.1.1/31, fd00::1/127)
    eth2 -> leafB (192.168.0.2/31, fd00::2/127)
    eth3 -> kind-switch (192.168.1.1/24, fd00:1::1/64)
  BGP: AS 64512, 3 peers (spine, kind-control-plane, kind-worker), EVPN enabled
