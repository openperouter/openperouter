...
func main() {
	...
	if *leafName == "" {
		fmt.Println("Usage: generate_leaf_config -leaf <name> -neighbor <ip> -network <cidr> -router-id <router ID> [options]")
		fmt.Println("Example: generate_leaf_config -leaf leafA -neighbor 192.168.1.0 -network 100.64.0.1/32 -router-id 100.64.0.1")
		flag.PrintDefaults()
		os.Exit(1)
	}
